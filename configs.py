...
class Config(object):
  ...
  DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://kunal2222:<password>@cluster0.wjqekma.mongodb.net/?retryWrites=true&w=majority")
  UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002006218830")
  LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002021058203"))
